...
- [`User_Manual.docx`](./docs/User_Manual.docx) — End-user guide
- [`Final_Report.docx`](./docs/Final_Report.docx) — System design & requirements report

---

*Built with ❤️ to simplify cross-border mobility in the Greater Bay Area*
