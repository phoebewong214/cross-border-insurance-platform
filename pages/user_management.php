...
<body>
            ...
            <div class="recommendation-content">
                <div class="recommendation-item">
                    ...
                    <div class="recommendation-text">
                        ...
                        <p>Medium Range: <span class="highlight" id="currentMediumLow">7</span> - <span class="highlight" id="currentMediumHigh">3</span></p>
                        <p>High Discount: <span class="highlight" id="currentHighDiscount">15</span>%</p>
                        <p>Medium Discount: <span class="highlight" id="currentMediumDiscount">10</span>%</p>
                ...
                <div class="recommendation-item">
                    ...
                    <div class="recommendation-text">
                        ...
                        <div id="historyList" class="history-list">
                            <!-- History records will be dynamically added via JavaScript -->
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function displayStats(users) {
            ...
            document.getElementById('highTransactionUsers').innerHTML = highTransactionUsers.length > 0 ? 
                highTransactionUsers.map(user => `
                    <div class="stats-user-item" data-user-id="${user.User_id}">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            // First fetch and apply the latest settings
        ...
        async function confirmAllDiscountUpdates() {
            ...
            // Get high transaction user IDs
            const highTransactionUsers = Array.from(document.querySelectorAll('#highTransactionUsers .stats-user-item'))
                .map(item => item.getAttribute('data-user-id'));
            
            // Get medium transaction user IDs
            const mediumTransactionUsers = Array.from(document.querySelectorAll('#mediumTransactionUsers .stats-user-item'))
                .map(item => item.getAttribute('data-user-id'));
            ...
            try {
                ...
                if (data.success) {
                    ...
                    // Update discount display in recommendation section
        ...
        async function fetchDiscountRates() {
            try {
                ...
                showToast('error', 'Error fetching discount rates');
            }
        }
        ...
        // Fetch and apply latest settings
        async function fetchAndApplyLatestSettings() {
            try {
                ...
                if (data.success && data.settings) {
                    ...
                    // Fetch user list after applying settings
                    fetchUsers();
                ...
                showToast('error', 'Error fetching settings');
            }
        }
        ...
        async function fetchHistory() {
            try {
                ...
                if (data.success && data.history) {
                    ...
                    // Display history records (skip the first one which is current settings)
                    const historyRecords = data.history.slice(1);
                    ...
                    historyRecords.forEach(record => {
                        ...
                        historyItem.innerHTML = `
                            ...
                            <p>Medium Range: ${record.medium_low_threshold} - ${record.medium_high_threshold}</p>
